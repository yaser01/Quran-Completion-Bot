...
from db.db import DATABASE_URI
from db.models import User, Khatma, Khatma_Done, Khatma_Parts, Khatma_Parts_Done, Quran_File
...
authentication_backend = AdminAuth(secret_key=_admin_secret_key)
