...
from db import db
from bot.Brodcast import send_canceled_khatma_message_to_users, send_canceled_khatma_message_to_users_due_to_expired
from config.Global_Files import Quran_Hafs_Pages_Images_Folder, Quran_Hafs_Tajwid_Pages_Images_Folder, \
    Quran_Hafs_Chapters_Folder, Quran_Hafs_Tajwid_Chapters_Folder, Resources_Folder
from bot.Global_Functions import QURAN_BOOK_ID, get_current_page_no_daily_page_quran, \
    set_next_page_no_daily_page_quran
from config.Keyboards import part_no_dict
